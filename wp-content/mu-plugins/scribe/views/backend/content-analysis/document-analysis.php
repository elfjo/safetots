				...
				<tr valign="top">
					...
					<?php
						if ( ! empty( $content_analysis->excludes ) ) {
							...
							printf( __( 'Note, the following term(s) are excluded from content analysis: %s. If you want to include these term(s) in the content analysis, please use the Target Term feature in Keyword Research.', 'scribeseo' ), $excludes );
