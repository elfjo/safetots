<div class="scribe-analysis-meta-box-container">
	<div class="scribe-analysis-meta-box-results misc-pub-section">
		<div class="scribe-analysis-meta-box-doc-score-container">
			<div data-content-analysis-score="<?php echo esc_attr( ( empty( $content_analysis ) ) ? '' : $content_analysis->docScore ); ?>" class="scribe-content-analysis-score scribe-analysis-meta-box-score <?php echo scribe_score_class( ( empty( $content_analysis ) ) ? '' : $content_analysis->docScore ); ?>">
				<?php
		...
		<div class="scribe-analysis-meta-box-site-score-container">
			<div data-content-analysis-score="<?php echo esc_attr( ( empty( $content_analysis ) ) ? '' : $content_analysis->scribeScore ); ?>" class="scribe-content-analysis-score scribe-analysis-meta-box-score <?php echo scribe_score_class( ( ( empty( $content_analysis ) ) ? '' : $content_analysis->scribeScore ), 'site' ); ?>">
				<?php
				if ( empty( $content_analysis ) ) {
					 esc_html_e( '-', 'scribeseo' );
