	...
	<tbody>
		...
		<tr valign="top">
			...
			<td>
				...
				<?php _e( 'Clicking the <strong>Send Report</strong> button will forward the above form, along with the details about your installation below to the support team.', 'scribeseo' ); ?>
