<div class="wrap scribe-metaboxes">
		<h2>
			<?php _e( 'Site Connections', 'scribeseo' ); ?>
		</h2>
			<div class="scribe-site-connections-tip-visible scribe-metabox">
			<p>A key part of online marketing is creating connections with others who are authoritative in their space. And with the Site Connection tool, we make it easy for you to find them.</p>
