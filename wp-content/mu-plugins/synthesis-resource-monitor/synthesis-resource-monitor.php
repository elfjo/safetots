...
class Synthesis_Resource_Monitor {
	...
	public static function disk_quota_markup() {
		...
		if ($quota_info != null) {
			...
			?>
			<div id="synthesis-disk-quota" class="postbox">
                    <h2 class='hndle'><span>Disk Quota</span></h2>
                    <div class="inside">
                    <table class="form-table">
                    <tbody>
                        <tr>
                        <th scope="row"><?php _e( 'Disk Quota Usage' ); ?></th>
                            <td>
								<p>
									<?php _e('Usage:'); ?>
    ...
    public static function sp_disk_quota_menu() {
        add_submenu_page( 'synthesis-software-monitor', __( 'Disk Quota' ), __( 'Disk Quota' ), 'install_plugins', 'sp-site-tools', array( __CLASS__, 'disk_quota_markup' ) );
    }
}
