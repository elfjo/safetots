<div class="scribe-wrap">
	<div class="scribe-link-building-tabs scribe-link-building-keyword-section">
			<div class="scribe-link-building-tip-visible">
				...
				<p>Like linking to external websites (using the <a href="<?php echo admin_url( 'admin.php?page=scribe-connections' ); ?>" target="_blank">Site Connector</a> tool), you can (and should) regularly use the
