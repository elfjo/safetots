				...
				<thead>
					<tr valign="top">
						<th class="scribe-keyword-suggestions-target" scope="col">
							...
							<a class="scribe-help-marker" href="#" data-placement="right" rel="popover" data-content="<?php esc_attr_e( 'A target keyword will be included in Content Analysis. You may select one target keyword.', 'scribeseo' ); ?>" title="<?php esc_attr_e('Target', 'scribeseo' ); ?>">?</a>
						</th>
